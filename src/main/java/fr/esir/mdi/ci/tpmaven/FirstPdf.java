...
public class FirstPdf {
    ...
    private static Font subFont = new Font(Font.FontFamily.TIMES_ROMAN, 16,
            Font.BOLD);
    private static com.itextpdf.text.Font smallBold = new Font(Font.FontFamily.TIMES_ROMAN, 12,
            Font.BOLD);
    ...
    static void neSertARien(Document inutile) {
    	System.out.print("Ceci est un code mort");
    }
